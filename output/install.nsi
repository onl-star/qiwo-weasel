...
VIAddVersionKey /LANG=2052 "FileDescription" "齊我輸入法"
...
LangString DISPLAYNAME ${LANG_TRADCHINESE} "齊我輸入法"
LangString LNKFORMANUAL ${LANG_TRADCHINESE} "【齐我输入法】說明書"
...
LangString LNKFORAPPFOLDER ${LANG_TRADCHINESE} "【齐我输入法】程序文件夾"
LangString LNKFORUPDATER ${LANG_TRADCHINESE} "【齐我输入法】檢查新版本"
LangString LNKFORSETUP ${LANG_TRADCHINESE} "【齐我输入法】安裝選項"
LangString LNKFORUNINSTALL ${LANG_TRADCHINESE} "卸載齊我輸入法"
LangString CONFIRMATION ${LANG_TRADCHINESE} "安裝前，請先卸載舊版本的齊我輸入法。$\n$\n按下「確定」移除舊版本，按下「取消」放棄本次安裝。"
...
LangString DISPLAYNAME ${LANG_SIMPCHINESE} "齐我输入法"
LangString LNKFORMANUAL ${LANG_SIMPCHINESE} "【齐我输入法】说明书"
...
LangString LNKFORAPPFOLDER ${LANG_SIMPCHINESE} "【齐我输入法】程序文件夹"
LangString LNKFORUPDATER ${LANG_SIMPCHINESE} "【齐我输入法】检查新版本"
LangString LNKFORSETUP ${LANG_SIMPCHINESE} "【齐我输入法】安装选项"
LangString LNKFORUNINSTALL ${LANG_SIMPCHINESE} "卸载齐我输入法"
LangString CONFIRMATION ${LANG_SIMPCHINESE} '安装前，请先卸载旧版本的齐我输入法。$\n$\n点击 "确定" 移除旧版本，或点击 "取消" 放弃本次安装。'
...
LangString DISPLAYNAME ${LANG_ENGLISH} "Qiwo Input Method"
...
LangString LNKFORAPPFOLDER ${LANG_ENGLISH} "Qiwo App Folder"
LangString LNKFORUPDATER ${LANG_ENGLISH} "Qiwo Check for Updates"
LangString LNKFORSETUP ${LANG_ENGLISH} "Qiwo Installation Preference"
LangString LNKFORUNINSTALL ${LANG_ENGLISH} "Uninstall Qiwo"
...
call_uninstaller:
  ...
  Delete  "$R1\data\*.*"
  RMDir /r "$R1\data\rime-frost"
  RMDir /r "$R1\qiwo-sync"
  Delete  "$R1\*.*"
...
program_files:
  ...
  ; Qiwo sync CLI
  SetOutPath $INSTDIR\qiwo-sync
  File /nonfatal "qiwo-sync\*.*"
  ; shared data files
  SetOutPath $INSTDIR\data
  File "data\*.yaml"
  File /nonfatal "data\*.txt"
  File /nonfatal "data\*.gram"
  ; bundled rime-frost resources
  SetOutPath $INSTDIR\data\rime-frost
  File /nonfatal /r "data\rime-frost\*.*"
  ; opencc data files
...
Section "Uninstall"
  ...
  Delete  "$INSTDIR\data\*.*"
  RMDir /r "$INSTDIR\data\rime-frost"
  RMDir /r "$INSTDIR\qiwo-sync"
  Delete  "$INSTDIR\*.*"

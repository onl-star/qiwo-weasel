  ...
  if (!wcscmp(L"/?", lpCmdLine) || !wcscmp(L"/help", lpCmdLine)) {
    ...
    if (LoadString(GetModuleHandle(NULL), IDS_STR_HELP, msg,
      ...
      MessageBox(
          ...
          L"/u             - Uninstall Qiwo\n"
          L"/i             - Install Qiwo\n"
          L"/s             - Install Qiwo (Simplified Chinese)\n"
          L"/t             - Install Qiwo (Traditional Chinese)\n"
          L"/ls            - Set Qiwo language to Simplified Chinese\n"
          L"/lt            - Set Qiwo language to Traditional Chinese\n"
          L"/le            - Set Qiwo language to English\n"
          ...
          L"QiwoSetup", MB_ICONINFORMATION | MB_OK);
    }
    return 0;
  }
